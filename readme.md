...
# ... set up kinematics, dynamics, and capsule geometry (see tests/python/conftest.py) ...
robot = blast.Manipulator(6, limits, kinematics, dynamics, capsules)

# 2. Define the motion task
...
print("Duration:", result.trajectory.pos.shape[1], "samples")
