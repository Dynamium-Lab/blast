...
set includes=-I "../../blast/" -I "../../blast/optional" -I "../../extern/nlopt/include/api" -I "../../extern/nlopt/include/algs" -I "multiple_compilation_units/" -I "../../extern/" -I "../../extern/eigen"
...
cl ../print_basis_functions.cpp /EHsc %includes% -std:c++17 -O2 /nologo /link /out:print_basis_functions.exe
