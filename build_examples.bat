...
set options= --std c++17 -m64 -O0 -g --expt-relaxed-constexpr -D BLAST_DEBUG -Xcompiler "-std:c++17 /MT /Zi /arch:AVX2"
...
nvcc ../main_collision_check.cu -o main_collision_check.exe %includes% %options% %libr%
