...
@REM set options= --std c++17 -m64 -O2 --expt-relaxed-constexpr -Xcompiler "-std:c++17 /MT /Z7 /arch:AVX2"
...
@REM set options= -std:c++17 -O2 /EHsc /MT /Z7 /arch:AVX2 /fp:fast /DNDEBUG
...
@REM nvcc ../main_collisions.cu nlopt.lib -o main_collisions.exe %includes% %options% %libr%
...
@REM nvcc ../main_collision_check.cu -o main_collision_check.exe %includes% %options% %libr%
cl ../main_collision_check.cpp /Fe: main_collision_check.exe %includes% %options%
