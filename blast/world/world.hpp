...
inline host_fn void World::add_box(const Box& box) {
  Assert(is_close(norm(box.rotation.col_copy(0)), (real) 1.0, 1e-5));
  Assert(is_close(norm(box.rotation.col_copy(1)), (real) 1.0, 1e-5));
  Assert(is_close(norm(box.rotation.col_copy(2)), (real) 1.0, 1e-5));
  Assert(is_close(norm(Vec3(box.rotation(0, 0), box.rotation(0, 1), box.rotation(0, 2))), (real) 1.0, 1e-5));
  Assert(is_close(norm(Vec3(box.rotation(1, 0), box.rotation(1, 1), box.rotation(1, 2))), (real) 1.0, 1e-5));
  Assert(is_close(norm(Vec3(box.rotation(2, 0), box.rotation(2, 1), box.rotation(2, 2))), (real) 1.0, 1e-5));

  boxes.push_back(box);
  size++;
}
inline host_fn void World::add_box(Vec3 center_point, Vec3 half_width, Mat3 rotation_matrix) {
  Assert(is_close(norm(rotation_matrix.col_copy(0)), (real) 1.0, 1e-5));
  Assert(is_close(norm(rotation_matrix.col_copy(1)), (real) 1.0, 1e-5));
  Assert(is_close(norm(rotation_matrix.col_copy(2)), (real) 1.0, 1e-5));
  Assert(is_close(norm(Vec3(rotation_matrix(0, 0), rotation_matrix(0, 1), rotation_matrix(0, 2))), (real) 1.0, 1e-5));
  Assert(is_close(norm(Vec3(rotation_matrix(1, 0), rotation_matrix(1, 1), rotation_matrix(1, 2))), (real) 1.0, 1e-5));
  Assert(is_close(norm(Vec3(rotation_matrix(2, 0), rotation_matrix(2, 1), rotation_matrix(2, 2))), (real) 1.0, 1e-5));
