...
struct Gen3 : Manipulator {
  ...
  std::vector<Mat3>    _rotations;      // put the rotation matrices temporarily when computing the constraints
  std::vector<Mat3>    _rotations_mult; // put the rotation matrices multiplications temporarily when computing the constraints
