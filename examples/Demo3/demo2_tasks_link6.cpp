...
int main() {
  ...
  manip.p_base = {1.4, 0, 0.883}; // link6
  manip.Q_base = {1, 0, 0, 0, 1, 0, 0, 0, 1};
  auto world = get_demo2_world();

  auto gen3_trajectory = transpose(read_csv_matrix_no_header("../../../examples/Demo3/trajectory_demo2_gen3.csv", ","));
  ...
  print_to_csv(trajectory, "../../../examples/Demo3/trajectory_demo2_Link6.csv");
  std::cout << "Trajectory printed." << std::endl;

  std::cout << "Printing results..." << std::endl;
  print_to_json(res, n_tests, "../../../examples/Demo3/results_demo2_Link6.json");
  std::cout << std::endl;
