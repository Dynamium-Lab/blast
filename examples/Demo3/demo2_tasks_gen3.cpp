...
int main() {
  ...
  print_to_csv(trajectory, "../../../examples/Demo3/trajectory_demo2_gen3.csv");
  std::cout << "Trajectory printed." << std::endl;

  std::cout << "Printing results..." << std::endl;
  print_to_json(res, n_tests, "../../../examples/Demo3/results_demo2_gen3.json");
  std::cout << std::endl;
