...
void bind_math(nb::module_& m) {
  ...
  nb::class_<Vec3>(m, "Vec3")
          ...
          .def("__init__", [](Vec3* self, nb::ndarray<nb::numpy, real, nb::ndim<1>> arr) {
            ...
            new (self) Vec3{d[0], d[1], d[2]}; }, nb::arg("array"))
          .def_rw("x", &Vec3::x)
          .def_rw("y", &Vec3::y)
          .def_rw("z", &Vec3::z)
          ...
          .def("to_numpy", [](const Vec3& v) { return vec3_to_numpy(v); }, "Return a copy as a (3,) numpy array.")
          .def_static("from_numpy", [](nb::ndarray<nb::numpy, real, nb::ndim<1>> arr) { return vec3_from_numpy(arr); }, nb::arg("array"), "Construct a Vec3 from a (3,) numpy array.")
  ...
  nb::class_<Mat3>(m, "Mat3")
          ...
          .def("__init__", [](Mat3* self, real a0, real a1, real a2, real a3, real a4, real a5, real a6, real a7, real a8) { new (self) Mat3{a0, a1, a2, a3, a4, a5, a6, a7, a8}; }, nb::arg("a0"), nb::arg("a1"), nb::arg("a2"), nb::arg("a3"), nb::arg("a4"), nb::arg("a5"), nb::arg("a6"), nb::arg("a7"), nb::arg("a8"), "Construct from 9 values stored column-by-column:\n"
                                                                                                                                                                                                                                                                                                                            "  Mat3(col0_row0, col0_row1, col0_row2,\n"
                                                                                                                                                                                                                                                                                                                            "       col1_row0, col1_row1, col1_row2,\n"
                                                                                                                                                                                                                                                                                                                            "       col2_row0, col2_row1, col2_row2)")
          .def("__init__", [](Mat3* self, nb::ndarray<nb::numpy, real, nb::ndim<2>> arr) { new (self) Mat3(mat3_from_numpy(arr)); }, nb::arg("array"), "Construct from a (3,3) numpy array (row-major convention).")
          .def("__call__", [](const Mat3& m, int r, int c) -> real {
            if (r < 0 || r >= 3 || c < 0 || c >= 3)
                throw nb::index_error("Mat3 index out of range");
            return m(r, c); }, nb::arg("row"), nb::arg("col"))
          .def("to_numpy", [](const Mat3& m) { return mat3_to_numpy(m); }, "Return a copy as a C-order (3,3) numpy array.")
          .def_static("from_numpy", [](nb::ndarray<nb::numpy, real, nb::ndim<2>> arr) { return mat3_from_numpy(arr); }, nb::arg("array"), "Construct a Mat3 from a (3,3) numpy array.")
