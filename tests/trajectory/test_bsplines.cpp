...
TEST_CASE("Basis function test", "[bspline]") {
    ...
    // CHANGING NUMBER OF CONTROL POINTS n_ctrl
    p = 5;
    n_ctrl = 10;
    ...
    // CHANGING NUMBER OF POINTS n_pts
    n_ctrl = 12;
    n_pts = 50;
    ...
    // CHANGING NUMBER OF JOINTS n_joints
    n_pts = 100;
    n_joints = 1;
    ...
    // Add velocity, acceleration basis function tests
}
